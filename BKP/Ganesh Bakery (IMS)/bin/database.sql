...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2015 at 10:08 AM
...
DROP TABLE IF EXISTS `cratepurch`;
...
--
ALTER TABLE `assets`
  MODIFY `assetid` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Asset ID';
--
...
--
ALTER TABLE `route_trip`
  MODIFY `tripid` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Trip ID';
--
