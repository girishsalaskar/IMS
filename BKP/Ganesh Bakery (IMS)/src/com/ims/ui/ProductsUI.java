	...
	private class ProductsUIListener implements ActionListener, KeyListener,
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnReset) {
				...
				// return;
				// }
				// else if(txtUnitName.getText().equals(""))
				// {
				// Statics.showMessage(getContentPane(),
				// "Please Enter Product's Unit Name!",
				// javax.swing.JOptionPane.ERROR_MESSAGE);
				// txtUnitName.requestFocus();
				// return;
				// }
				// else if(txtUnitDesc.getText().equals(""))
				// {
				// Statics.showMessage(getContentPane(),
				// "Please Enter Product Unit's Description!",
				// javax.swing.JOptionPane.ERROR_MESSAGE);
				// txtUnitDesc.requestFocus();
				// return;
				// }
				// else if(txtProdDesc.getText().equals(""))
				// {
				// Statics.showMessage(getContentPane(),
				...
				// return;
				// }
				// else if(cboProdCat.getSelectedIndex()<0)
				// {
				// Statics.showMessage(getContentPane(),
				// "Please Select Product Category",
				// javax.swing.JOptionPane.ERROR_MESSAGE);
				// cboProdCat.requestFocus();
				// return;
				// }
				if (!validateFields()) {
					Statics.showMessage(
