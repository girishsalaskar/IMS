 ...
 * @author Girish
 */
public class EmpAttendanceReportUI extends IFrame {

	private static final long serialVersionUID = -1423204352229874694L;
	...
	private class EmpSalReportUIListen implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnReset) {
				...
				ReportViewer view = new ReportViewer("empattendance", map,
