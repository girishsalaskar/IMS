 ...
 * @author Girish
 */
public class EmpSalReportUI extends IFrame {

	private static final long serialVersionUID = 6272857279854801865L;
	...
	private class EmpSalReportUIListen implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnReset) {
				...
				ReportViewer view = new ReportViewer("salaryreport", map,
