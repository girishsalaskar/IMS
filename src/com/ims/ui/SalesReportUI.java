...
public class SalesReportUI extends IFrame {
	...
	private javax.swing.JButton btnQSShow;
	...
	private DateButton dpkQSEndDate;
    private DateButton dpkQSStartDate;
	...
	private javax.swing.JPanel pnlQuickSales;
	...
	public SalesReportUI() {
		...
		btnQSShow.addActionListener(listen);
		...
		lblStartDate1.setText(Program.LANG.getProperty("lblstartdate"));
		lblEndDate1.setText(Program.LANG.getProperty("lblenddate"));
		btnQSShow.setText(Program.LANG.getProperty("btnshow"));
	}
	...
	private void initComponents() {
        ...
        pnlQuickSales = new javax.swing.JPanel();
        lblStartDate1 = new javax.swing.JLabel();
        dpkQSStartDate = new DateButton();
        btnQSShow = new javax.swing.JButton();
        lblEndDate1 = new javax.swing.JLabel();
        dpkQSEndDate = new DateButton();
		...
		pnlQuickSales.setLayout(null);

        lblStartDate1.setFont(Statics.NORMAL_LARGE_FONT);
        lblStartDate1.setText("Starting Date");
        pnlQuickSales.add(lblStartDate1);
        lblStartDate1.setBounds(40, 40, 180, 40);

        dpkQSStartDate.setFont(Statics.NORMAL_LARGE_FONT);
        pnlQuickSales.add(dpkQSStartDate);
        dpkQSStartDate.setBounds(220, 40, 170, 40);

        btnQSShow.setFont(Statics.NORMAL_LARGE_FONT);
        btnQSShow.setText("Show");
        pnlQuickSales.add(btnQSShow);
        btnQSShow.setBounds(130, 210, 170, 60);

        lblEndDate1.setFont(Statics.NORMAL_LARGE_FONT);
        lblEndDate1.setText("Ending Date");
        pnlQuickSales.add(lblEndDate1);
        lblEndDate1.setBounds(40, 120, 180, 40);

        dpkQSEndDate.setFont(Statics.NORMAL_LARGE_FONT);
        pnlQuickSales.add(dpkQSEndDate);
        dpkQSEndDate.setBounds(220, 120, 170, 40);

        tbpSalesReport.addTab("Quick Sales", pnlQuickSales);
	...
	private class SalesReportUIListener implements ActionListener,
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnShowCust) {
				...
				map.put("prmfirmid", firm.getFirmData().firmid);
				ReportViewer view = new ReportViewer("datewisesaleslist",
						map, firm.getConnectionObj());
				view.showReport();
			} else if(e.getSource()==btnQSShow)	{
				HashMap<String, Object> map = new HashMap<>();
				Firm firm = new Firm();
				map.put("prmstartdate", dpkQSStartDate.getDate());
				map.put("prmenddate", dpkQSEndDate.getDate());
				map.put("prmfirmid", firm.getFirmData().firmid);
				ReportViewer view = new ReportViewer("datewisequicksales",
						map, firm.getConnectionObj());
				view.showReport();
			}
		}
